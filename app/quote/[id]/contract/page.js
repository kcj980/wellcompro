      ...
      <div ref={printRef} className="print-this-section bg-white p-6 border border-gray-300 rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="border border-gray-300 rounded-lg p-4">
            <h2 className="text-lg font-bold mb-2 text-center border-b border-gray-300 pb-2">공급자 (갑)</h2>
          ...
          <div className="border border-gray-300 rounded-lg p-4">
            <h2 className="text-lg font-bold mb-2 text-center border-b border-gray-300 pb-2">공급받는자 (을)</h2>
            <div className="space-y-2">
              <div className="flex">
                <span className="font-semibold w-24">상호:</span>
        ...
        <div className="mb-6">
          ...
          <p className="mb-4 pl-4">본 계약은 갑이 을에게 아래와 같은 제품 및 서비스를 제공하고, 을은 이에 대한 대금을 지급함에 있어 제반 사항을 정함을 목적으로 한다.</p>
          ...
          <div className="pl-4 mb-4 space-y-2">
            ...
            <ul className="list-disc pl-8">
              <li>계약금: 계약 체결 시 50% ({Math.round(estimate.totalAmount * 0.5).toLocaleString()}원)</li>
              <li>잔금: 납품 완료 시 50% ({Math.round(estimate.totalAmount * 0.5).toLocaleString()}원)</li>
            </ul>
            <p>3. 입금계좌: {estimate.bankAccount || '국민은행 123-456-789012 (예금주: 웰컴프로)'}</p>
          </div>
          ...
          <p className="pl-4 mb-4">본 계약의 내용을 변경하거나 해지하고자 할 경우에는 상호 협의하에 서면으로 진행한다. 단, 일방적인 계약 해지 시에는 위약금이 발생할 수 있다.</p>
          
          <h2 className="text-lg font-bold mb-3">제5조 (분쟁해결)</h2>
          <p className="pl-4 mb-4">본 계약과 관련하여 분쟁이 발생할 경우, 양 당사자는 상호 협의하여 해결하며, 협의가 이루어지지 않을 경우 갑의 소재지를 관할하는 법원의 판결에 따른다.</p>
        ...
        <div className="mt-8">
          <p className="text-center mb-6">위와 같이 계약을 체결하고 이를 증명하기 위하여 계약서 2부를 작성하여 갑과 을이 각각 서명 날인 후 1부씩 보관한다.</p>
